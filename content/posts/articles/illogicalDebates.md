...
tags: ["english", "logic", "philosophy","social","opinion","politics","essay"]
...
Indeed, a great amount of discourse, notably coming from contrarians, seems not to focus on debating statements or assertions, but proving the opponent’s inference to be wrong, ill-willed, and thereby not claiming axioms of their own, no weight to bear themselves. Instead, they simply attack the assumed stability of the opposed discourse.
...
I believe this strategy is even stronger than advocating for axioms of your own. As mentioned before, it doesn’t involve commitment to any ideas. Rather, it allows to present oneself as the great keeper of the well-order of the discussion, the repeller of all subtle fallacies and simplifications, an arbiter of sort, granting authority on the debate, even though one is still a participant. And all this can hardly be viewed in a negative light&nbsp;: serious debate should be kept to an utmost standard of validity. Who would want to listen to politicians who don’t even make sense&nbsp;? It is then completely possible, understandable, (and, here, sadly, the parable leaks heavily into reality) to have Classicalists only attack Intuitionists’ inferences, without presenting, nor defending, their own axioms, once again messing with the balance of the debate. The scale sheltering an empty side, self-assigned the task to keep an eye over it.

## Debates for debates, speaking of words

But much like in logic itself, where language and meta-language must crucially be different, axioms and inferences, one’s premises and argumentation, lie on different levels and thus cannot blend. Focusing on inference rules is forgetting they only apply to the discourse itself, whereas the axioms apply to the concrete, in our case, to actual lives. In short, debating about the validity of an argumentation is really only debating about the debate, not what the debate is about.

One of the consequences of this meta-ification of debates is that they become far remote from people who do not typically engage in verbal jousts. Debates, and a fortiori most politics, get more and more estranged from those who care about the axioms, about life. This can be clearly observed in the upbringing of political figures, more often than not trained in communication and media, rather than spontaneously defending what they take at heart. Of course, clarity and precision of discourse should not necessarily be seen as unwanted, and ensuring validity of reasoning neither, but it shouldn’t make for the entirety of one side’s position. I perfectly understand one might prefer this overzealous “seriousness” for politics, though I personally do not, for the main goal of a traditional politician is representing their people, and this clear divide, those people feeling estranged, seems to contradict that very first motive. Now might be a good time to remind ourselves that all of this was a specific case. We are still talking about how we should understand what a debate is in general. These political disputes are but one of the ugly implications of how we treat discussions as an idea.

All that being said, what possible view, or definition, of debate could help us avoid those issues&nbsp;? Well, a first approach would be to focus on what participants argue for. Notably, in our previous account, there is nothing stopping us from considering a debate between two participants holding the same world view. As long as they argue and try to convince, it would still be a debate, and for they might never criticise the other’s position (as it is their own), no contradiction would blatantly appear. But this intuitively doesn’t feel like “real” debate. Our prior definition, then, cannot be complete. I believe it is thus essential to keep in mind what participants defend (even implicitly), and to require they do actually defend something, not just attack, to grow healthy debates, and, as a plus, avoid unnecessary ones, the likes of which we just mentioned. If form is what they only use, then let us use nomenclature to undermine their speech. Healthy debates, or none.
...
Rather than aiming for bullet-proof argumentation, let us speak of what resonates, of what someone might be willing to fight for.

Debate about the axioms.

[^1]: The mentioned article is listed on this website as *"De l'art de faire gagner les deux camps"*. This footnote was obviously not present in the original article, it would have otherwise been a strange foresight.
